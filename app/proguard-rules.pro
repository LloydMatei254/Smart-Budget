...
# Data Models
# ============================
# Keep all data classes (domain models, DTOs, entities)
-keep class com.example.smartbudget.domain.model.** { *; }
-keep class com.example.smartbudget.data.remote.dto.** { *; }
-keep class com.example.smartbudget.data.local.entities.** { *; }
...
# Keep Fragment and its constructors
